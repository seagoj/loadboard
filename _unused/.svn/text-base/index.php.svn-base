...
<link href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/inc.style.css" rel="stylesheet" type="text/css" media="screen" />

<body>
<div id='header' style='text-align:center'>
	<div class='logo'><img src ='images/logo_sunsetSub.png' /></div>
	Sunset Load Board
</div>
...
?>
<!--//<div id='footer'><a href='inc.config.php'>Edit Board</a></div>//-->
</body>
</html>