...
var richhtmlticker={
loadingtext: '<em>Loading...</em>', //Loading text if content is being fetched via Ajax
...
cleanup:function(config){
	jAlert(config.$ticker.html(content));
...
richhtmlticker.define({
	id: "content", //main ticker DIV id
	msgclass: "messagediv", //CSS class of DIVs containing each ticker message
	msgsource: "inc.loads.php", //Where to look for the messages: "inline", or "path_to_file_on_your_server"
